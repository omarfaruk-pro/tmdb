          ...
          >
            ...
            >
              <li role="none" className="flex items-stretch">
                <NavLink
                  className="text-xl flex items-center gap-2 py-4 transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600 focus:outline-none focus-visible:outline-none lg:px-8"
                  to={"/"}
                >
                  <span>Home</span>
                </NavLink>
